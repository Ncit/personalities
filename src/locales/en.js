export const en = {
    ...
    frameworkInfo: {
        ...
        keirseyTitle: 'Keirsey Temperament Sorter',
        keirseyDesc: "David Keirsey's temperament model groups the 16 MBTI types into 4 temperaments based on observable behavior patterns. Focuses on what people do rather than how they think.",
        keirseySP: 'Artisan (SP)',
        keirseySPDesc: 'Concrete, action-oriented, freedom-seeking',
        keirseySJ: 'Guardian (SJ)',
        keirseySJDesc: 'Concrete, organized, duty-fulfilling',
        keirseyNT: 'Rational (NT)',
        keirseyNTDesc: 'Abstract, objective, systems-building',
        keirseyNF: 'Idealist (NF)',
        keirseyNFDesc: 'Abstract, empathic, meaning-seeking',
