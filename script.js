...
class MBTIQuiz {
    ...
    generateQuestions() {
        ...
        if (isPremiumUser) {
            ...
            // Free version: 20 essential questions
            return [
                // E vs I (5 questions)
                {
                    question: "How do you prefer to spend your free time?",
                ...
                // T vs F (5 questions)
                {
                    ...
                    options: [
                        "Analyze the facts and logic",
                        "Consider how others will feel",
                        "Trust your gut instinct",
                        "Weigh both logic and feelings"
                    ],
                    dimension: "TF",
                    weights: [3, -2, 0, 1]
                },
                {
                    question: "In conflicts, you prefer to:",
                    options: [
                        "Find the most logical solution",
                ...
                {
                    question: "You value people who are:",
                    options: [
                        "Competent and efficient",
                ...
                },
                {
                    ...
                    options: [
                        "Focus on facts and improvement",
                ...
                // J vs P (5 questions)
                {
                    ...
                    options: [
                        ...
                        "Go with the flow and adapt as needed"
                    ],
                    dimension: "JP",
                    weights: [3, -2, 1, -1]
                },
                {
                    ...
                    options: [
                        ...
                        "Have a timeline but adjust as needed",
                        "Let the project evolve naturally"
                    ],
                    dimension: "JP",
                    weights: [3, -2, 1, -1]
                },
                ...
                },
                {
                    question: "When making decisions, you:",
                    options: [
                        "Want to decide quickly and move on",
                        "Keep gathering information",
                        "Consider options but don't delay",
                        "Take time to explore all possibilities"
                    ],
                    dimension: "JP",
                    weights: [2, -2, 1, -1]
                },
                {
                    question: "You feel most comfortable when:",
                    options: [
                        "Things are planned and organized",
                        "You have flexibility and options",
                        "There's structure but room to adapt",
                        "You can be spontaneous and creative"
                    ],
                    dimension: "JP",
                    weights: [2, -2, 1, -1]
                }
